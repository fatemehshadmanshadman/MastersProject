...
//css
const HeaderRow = tw.div`flex justify-between items-center flex-col xl:flex-row mt--16`;
...
const x="/components/learn/Tab.js";
export default ({
  heading = "آموزش ها",
  tabs = {
    "ICDL": ICDLCards(),
          ...
          >
            {tabs[tabKey].map((card, index) => (
              <CardContainer key={index}>
                <Card  href={card.url} initial="rest" whileHover="hover" animate="rest">
